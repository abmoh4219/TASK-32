...
- Name: analytics.spec.ts >> Analytics >> non-finance role is denied analytics access
- Location: frontend/tests/e2e/analytics.spec.ts:47:7
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - paragraph [ref=e6]:
      - text: We can’t connect to the server at app.
      - generic [ref=e7]:
        - text: Did you mean to go to
        - link "www.app.com" [ref=e8] [cursor=pointer]:
          - /url: https://www.app.com:3000/
        - text: "?"
    - paragraph
    - generic [ref=e9]:
