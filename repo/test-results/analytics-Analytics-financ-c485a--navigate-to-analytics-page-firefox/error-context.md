...
- Name: analytics.spec.ts >> Analytics >> finance manager can navigate to analytics page
- Location: frontend/tests/e2e/analytics.spec.ts:12:7
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - paragraph [ref=e6]: We can’t connect to the server at app.
    - paragraph
    - generic [ref=e7]:
